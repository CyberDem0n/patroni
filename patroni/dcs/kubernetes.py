            ...
            for i, base_uri in enumerate(api_servers_cache):
                ...
                try:
                    ...
                    if not retry:
                        ...
                        raise K8sException('{0} {1} request failed: {2}'.format(method, path, e))
...
class Kubernetes(AbstractDCS):
    ...
    def _citus_cluster_loader(self, path):
        ...
        for pod in path['pods']:
            ...
            if parse_int(group) is not None:
        ...
        return {group: self._cluster_from_nodes(group, value['nodes'], value['pods'])
